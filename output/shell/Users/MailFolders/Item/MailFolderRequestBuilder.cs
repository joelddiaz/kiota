using ApiSdk.Users.MailFolders.ChildFolders;
using ApiSdk.Users.MailFolders.MessageRules;
using ApiSdk.Users.MailFolders.Messages;
using ApiSdk.Users.MailFolders.MultiValueExtendedProperties;
using ApiSdk.Users.MailFolders.SingleValueExtendedProperties;
using ApiSdk.Users.MailFolders.UserConfigurations;
...
namespace ApiSdk.Users.MailFolders.Item {
    ...
    public class MailFolderRequestBuilder {
        ...
        public UserConfigurationsRequestBuilder UserConfigurations { get =>
            new UserConfigurationsRequestBuilder(CurrentPath + PathSegment , HttpCore, false);
        }
        /// <summary>
